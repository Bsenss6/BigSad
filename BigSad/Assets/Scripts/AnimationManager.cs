...
public class AnimationManager : MonoBehaviour
{
    ...
    {
        Instantiate(note, jack.transform.position , Quaternion.identity);
    }

    void PlayAnimation_k()
    {
        Instantiate(note, king.transform.position, Quaternion.identity);

    }

    void PlayAnimation_l()
    {
        Instantiate(note, lion.transform.position, Quaternion.identity);
    }
